                    ...
                    if is_quote_tweet:
                        ...
                        if quoted_status_id:
                            ...
                            if quoted_post.account_id == cst.NUANCE_SOCIAL_ACCOUNT_ID:
                                ...
                                logger.debug(f"🚫 Post {post_id} quotes post {quoted_status_id} from account {quoted_post.account_id}, not Nuance account {cst.NUANCE_SOCIAL_ACCOUNT_ID}")
                        else:
                            logger.debug(f"🚫 Post {post_id} is quote tweet but no quoted_status_id found")
                    else:
                        logger.debug(f"🚫 Post {post_id} is not a quote tweet")
